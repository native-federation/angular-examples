...
import { createCustomElement as D } from "@angular/elements";
import { DestroyRef as b, inject as m, signal as y } from "@angular/core";
import { FormBuilder as k, ReactiveFormsModule as x, Validators as s } from "@angular/forms";
import { navigateTo as S, storeSelected as E } from "@ng-internal/event-bus";
import { ButtonComponent as N } from "@ng-internal/ui";
import { inject as C } from "@angular/core";
import { NavigateToDirective as v } from "@ng-internal/navigation";
import * as t from "@angular/core";
var c = class i {
    image = C(_);
    logoUrl = this.image.cdnUrl("/cdn/img/logo.svg");
    static \u0275fac = function (o) { return new (o || i); };
    static \u0275cmp = t.\u0275\u0275defineComponent({ type: i, selectors: [["app-compact-header"]], hostAttrs: ["role", "banner", 1, "c_CompactHeader"], decls: 3, vars: 2, consts: [[1, "c_CompactHeader__inner"], [1, "c_CompactHeader__link", 3, "appNavigateTo"], ["alt", "Micro Frontends - Tractor Store", 1, "c_CompactHeader__logo", 3, "src"]], template: function (o, n) { o & 1 && (t.\u0275\u0275elementStart(0, "div", 0)(1, "a", 1), t.\u0275\u0275element(2, "img", 2), t.\u0275\u0275elementEnd()()), o & 2 && (t.\u0275\u0275advance(), t.\u0275\u0275property("appNavigateTo", "explore.home"), t.\u0275\u0275advance(), t.\u0275\u0275property("src", n.logoUrl, t.\u0275\u0275sanitizeUrl)); }, dependencies: [v], styles: [`:host{height:80px;display:flex;margin:1rem 0 2rem;border-bottom:1px solid #eeebe2;align-items:center}.c_CompactHeader__inner{display:flex;max-width:calc(1000px + 2 * var(--outer-space));padding:0 var(--outer-space);margin:0 auto;align-items:center;flex:1}.c_CompactHeader__logo{display:block;width:175px;aspect-ratio:3.5}
`], encapsulation: 3 });
};
...
var l = class i {
    ...
    cart = m(f);
    loader = m(d);
    constructor() { this.loader("@tractor-store/explore", "mfe-store-picker"), this.loader("@tractor-store/explore", "mfe-footer"); let r = E.on(({ id: o }) => this.applyStoreId(o)); m(b).onDestroy(r); }
    storeId = y("");
    form = this.fb.nonNullable.group({ firstname: ["", s.required], lastname: ["", s.required], storeId: [{ value: "", disabled: !1 }, s.required] });
