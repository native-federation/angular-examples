...
import { createCustomElement as P } from "@angular/elements";
...
function b(r, i) { if (r & 1) {
    let t = e.\u0275\u0275getCurrentView();
    e.\u0275\u0275elementStart(0, "li", 8)(1, "div", 11), e.\u0275\u0275element(2, "img", 9), e.\u0275\u0275elementStart(3, "p", 10), e.\u0275\u0275text(4), e.\u0275\u0275element(5, "br"), e.\u0275\u0275text(6), e.\u0275\u0275element(7, "br"), e.\u0275\u0275text(8), e.\u0275\u0275elementEnd()(), e.\u0275\u0275elementStart(9, "ts-button", 12), e.\u0275\u0275listener("click", function () { let n = e.\u0275\u0275restoreView(t).$implicit, S = e.\u0275\u0275nextContext(); return e.\u0275\u0275resetView(S.select(n)); }), e.\u0275\u0275text(10, " select "), e.\u0275\u0275elementEnd()();
} if (r & 2) {
    let t = i.$implicit;
...
var g = "mfe-store-picker";
function $(r, i) { return s(this, null, function* () { let t = yield d(r, i); customElements.get(g) || customElements.define(g, P(a, { injector: t })); }); }
export { $ as bootstrap };
